...
library StorageInterface {
    ...
    bytes32 constant BOOK_IDENTIFIER = "book";
    ...
    struct Bytes32BookMapping {
      Book innerMapping;
    }

    struct UIntBookMapping {
      Bytes32BookMapping innerMapping;
    }
    ...
    function init(Book storage self, bytes32 _id) internal {
      init(self.title, keccak256(_id, 'title'));
      init(self.author, keccak256(_id, 'author'));
